...
<%
    ...
    try {
        ...
        if (patientIdParam == null || patientIdParam.isEmpty()) {
            ...
            String patientSql = "SELECT * FROM patientstb WHERE id = ?";
            ...
            if (rs.next()) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="print-hidden">
                                ...
                                <form method="post">
                                    ...
                                    <a href="ReportPaiHs.jsp" class="mdc-button mdc-button--raised mdc-button--info">Back</a><br><br>
                                </form>
                            </div>
                            
                            <!-- Print Button -->
                            <div class="mb-3">
                                <button class="mdc-button mdc-button--raised mdc-button--success print-visible" onclick="printPatientHistory()">Print Patient History</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>View Patient History</h2><div class='alert alert-danger' role='alert'>Patient not found. Please provide a valid ID.</div><a href='PatientList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
            }
        }
