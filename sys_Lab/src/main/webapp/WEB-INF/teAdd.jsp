...
<%
    ...
    try {
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            String sql = "INSERT INTO teststb (patient_id, test_name, test_date, test_time, test_result) VALUES (?, ?, ?, ?, ?)";
            ...
            if (rowsAffected > 0) {
                out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>Add Test</h2><div class='alert alert-success' role='alert'>Test added successfully!</div><a href='TestList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
            } else {
                out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>Add Test</h2><div class='alert alert-danger' role='alert'>Failed to add test. Please try again.</div><a href='TestList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
            }
        }
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <button type="submit" class="mdc-button mdc-button--raised mdc-button--primary">Add Test</button>
                    <a href="telst.js" class="mdc-button mdc-button--raised mdc-button--info">Back</a>
                </form>
            </div>
        </div>
    </div>
