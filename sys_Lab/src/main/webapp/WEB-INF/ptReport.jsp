...
<div class="container text-center">
    ...
    <div class="mt-4">
        <a href="repPtLi.jsp" class="mdc-button mdc-button--raised mdc-button--success mdc-button--dense">Test Reports</a>
        <a href="repPtHs.jsp" class="mdc-button mdc-button--raised mdc-button--info mdc-button--dense">Patient Reports</a>
    </div>
</div>
