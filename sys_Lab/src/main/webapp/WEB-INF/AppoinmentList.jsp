      ...
      <div class="content">
         <div class="card">
            ...
            <div class="card-body">
               <!-- CRUD Operations -->
               <div class="mb-3">
                  <a href="appAdd.jsp" class="btn btn-primary">Add Appointment</a>
               </div>
                  ...
                  <tbody>
                     <% 
                        ...
                        try {
                            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_lab", "root", "");
                            Statement stmt = conn.createStatement();
                            ResultSet rs = stmt.executeQuery("SELECT * FROM appoindatatb");
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="AppEdit.jsp?id=<%= rs.getString("id") %>" class="btn btn-warning btn-sm">Edit</a>
                           <a href="AppDel.jsp?id=<%= rs.getString("id") %>" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                     </tr>
                     <%
                        }
