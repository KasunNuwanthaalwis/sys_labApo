                ...
                <tbody>
                    <% 
                        ...
                        try {
                            ...
                            ResultSet patientResult = stmt.executeQuery("SELECT * FROM patientstb WHERE username = '" + usernameFromSession + "'");
                            if (patientResult.next()) {
                                int patientId = patientResult.getInt("id");
                                // Fetch reports based on the patient_id
                                ResultSet rs = stmt.executeQuery("SELECT * FROM patientstb WHERE id = " + patientId);
                    ...
                    %>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="repPtLi.jsp?reportId=<%= rs.getInt("id") %>" class="mdc-button mdc-button--raised mdc-button--warning">View Report</a>
                                        </td>
                                    </tr>
                    <%
                                }
