...
<head>
    ...
    <style>
        ...
        .appointment-container {
            max-width: calc(100% - 250px); /* Adjust the width to fit within sidebar */
            margin-left: 250px;
            padding: 20px;
        }
...
<%
    ...
    try {
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            String sql = "INSERT INTO appoindatatb (patient_id, appointment_date, appointment_time, doctor_name, appointment_purpose) VALUES (?, ?, ?, ?, ?)";
