...
<div class="content">
    ...
    <!-- CRUD Operations -->
    <div class="mb-3">
        <a href="badd.jsp" class="btn btn-primary">Add Bill</a>
    </div>
    ...
    String getPatientName(int patientId) {
        String fullName = "";
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_lab", "root", "");
                        ...
                        <tbody>
                            <% 
                                ...
                                try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/lb", "root", "");
                                     Statement stmt = conn.createStatement();
                                     ResultSet rs = stmt.executeQuery("SELECT * FROM billtb")) {
                            ...
                            %>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="bedit.jsp?id=<%= rs.getString("id") %>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="bdel.jsp?id=<%= rs.getString("id") %>" class="btn btn-danger btn-sm">Delete</a>
                                                <a href="bSent.jsp?id=<%= rs.getString("id") %>" class="btn btn-info btn-sm">Send Email</a>
                                            </td>
                                        </tr>
                            <%
                                    }
