    ...
    try {
        ...
        if (testIdParam == null || testIdParam.isEmpty()) {
            ...
            if (request.getMethod().equals("POST")) {
                ...
                String updateSql = "UPDATE teststb SET test_name=?, test_date=?, test_time=?, test_result=? WHERE id=?";
                ...
                if (rowsUpdated > 0) {
                    out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>Edit Test</h2><div class='alert alert-success' role='alert'>Test details updated successfully.</div><a href='TestList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
                } else {
                    out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>Edit Test</h2><div class='alert alert-danger' role='alert'>Failed to update test details. Please try again.</div><a href='TestList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
                }
            }

            // Fetch the updated test details
            String sql = "SELECT * FROM teststb WHERE id = ?";
            ...
            if (rs.next()) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <a href="telst.jsp" class="mdc-button mdc-button--raised mdc-button--info">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                out.println("<div class='container mt-3'><div class='card'><div class='card-body'><h2 class='card-title text-center mb-4'>Edit Test</h2><div class='alert alert-danger' role='alert'>Test not found. Please provide a valid ID.</div><a href='TestList.jsp' class='mdc-button mdc-button--raised mdc-button--info'>Back</a></div></div></div>");
            }
        }
